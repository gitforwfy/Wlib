...
import com.wuzhou.wlibrary.http.download.listener.DownloadListener;
import com.wuzhou.wlibrary.http.download.task.ExecutorWithListener;
...
public class DownloadManager {
   ...
   public static DownloadManager getInstance(Context context) {
     ...
     * 获取当前设置的下载路径
     *
     * （机身存储/内存卡）/AR_BOOK/download/
     * @return
     */
    public String getTargetFolder(){
        String dir= msdcard + File.separator + root + File.separator + "download" + File.separator;
   ...
   private void addTask(@NonNull String url, DownloadListener listener, boolean isRestart) {
       ...
       if (downloadInfo == null) {
           ...
           downloadInfo.setTargetFolder(getTargetFolder());
